...
def evaluate(binary_dataset, mlp_int, split):
...
if __name__ == '__main__':
    ...
    for dataset_size in ['binary_undersample', 'binary_wiki_aug']:
        ...
        if not RANDOM_SELECTION:
            results_dct = evaluate(bin_ds, mlp_int, split)
            ...
            for num_samples in [3, 6, 9, 12]:  # choose only a certain number of samples
                ...
                for i in range(repetitions):
                    ...
                    temp_res = evaluate(mod_bin_ds, mlp_int, split)  # temporary results
                ...
                # save_results('mlp', 'oos-binary', dataset_size, num_samples,
